...
class AppTheme {
  static ThemeData themeData(BuildContext context) { 
    return ThemeData(
        textTheme: TextTheme(titleLarge: TextStyle(color: Color(0xffAF87FF), fontSize: 30,),
        titleMedium: TextStyle(color: Colors.white, fontSize: 22,),
        bodyMedium: TextStyle(color: Color(0xffE7DBFF), fontSize: 16,)
        ),
        ...
        bottomNavigationBarTheme: BottomNavigationBarThemeData(elevation: 2, 
